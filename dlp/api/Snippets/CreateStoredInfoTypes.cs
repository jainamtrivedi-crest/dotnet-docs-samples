...
{
    public static StoredInfoType Create(string projectId, string gcsUri, string outputPath)
    {
        // Instantiate the dlp client.
        var dlp = DlpServiceClient.Create();

        // Construct the stored infotype config using the gcs uri and output path.
        ...
        // Call the API.
        var response = dlp.CreateStoredInfoType(request);
